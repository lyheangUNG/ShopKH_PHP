                            ...
                            <div class="pl-lg-4">
                                <div class="row">
                                    <div class="col-lg-6 col-sm-12">
                                            ...
                                            <input type="text" name="name" id="input-name" class="form-control" placeholder="Username" required>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-sm-12">
                                            <div class="form-group">
                                            <label class="form-control-label" for="input-fname">Full Name</label>
                                            <input type="text" name="fname" id="input-fname" class="form-control" placeholder="Full Name" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-12">
                                            ...
                                            <input type="text" name="email" id="input-email" class="form-control" placeholder="Email" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="text-center">
                                    <button type="submit" class="btn btn-success mt-4" name="register_btn">Save</button>
                                </div>
                            </div>
                        </form>
                    </div>
