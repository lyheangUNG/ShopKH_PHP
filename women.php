<?php
    ...
    $categories = $db->listDB("select * from categories where parent_id IS NOT NULL and parent_id = 2");
    ...
    <div class="popular-product-area wrapper-padding-3 pt-115 pb-0">
            <div class="container-fluid">
                <div class="section-title-6 mb-50">
                    <h3><span style="background: red;color:white;padding:10px;" id = "#<?php echo $category['category']?>" ><?php echo $category['category']?></span></h3>
        ...
        <?php 
                        ...
                        ?>
        <!-- <button><a href="#Watch(F)" >GO to watch</a></button>
    <a href="#Shirt(F)">Go to Shirt</a> -->
<?php
            include "footer.php";
?>